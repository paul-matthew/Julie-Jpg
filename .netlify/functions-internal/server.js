...
// app/styles/app.css
var app_default = "/build/_assets/app-EXRY5AX5.css";
...
async function getDataFromStrapi(path, query) {
  try {
    let baseUrl3, apiToken;
    baseUrl3 = "http://127.0.0.1:1337", apiToken = "", console.log("This is a local build yo");
    let url = `${baseUrl3}/api/${path}?${query}`, response = await fetch(url, {
      headers: {
...
function HomeRoute() {
  ...
  return /* @__PURE__ */ import_react3.default.createElement("div", {
  ...
  }), /* @__PURE__ */ import_react3.default.createElement("picture", null, /* @__PURE__ */ import_react3.default.createElement("source", {
    srcSet: "/cover2-mobile.jpg",
    media: "(max-width: 600px)"
  }), /* @__PURE__ */ import_react3.default.createElement("source", {
    srcSet: "/cover2desktop.jpg",
    ...
    className: "relative z-10 mx-auto max-w-7xl px-6 pt-40 lg:pt-64 xl:px-6 2xl:px-0"
  }, /* @__PURE__ */ import_react3.default.createElement("div", {
  ...
  }, "On an endless journey to create experiences that inspire others. Always motived by artwork that's honest, aesthetic and natural.  Join me on my personal journey in the discovery and creativity of everything artistic."), /* @__PURE__ */ import_react3.default.createElement("a", {
    "data-rellax-speed": "1",
    "data-rellax-xs-speed": "0",
    "data-rellax-mobile-speed": "0",
    href: "#work",
    ...
    className: "text-7xl font-bold text-white xl:text-8xl",
    style: { fontFamily: "Covered by Your Grace", textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)" }
  }, "My services")), /* @__PURE__ */ import_react3.default.createElement("div", {
    className: "mt-24"
  }, /* @__PURE__ */ import_react3.default.createElement("div", {
    className: ""
  }, /* @__PURE__ */ import_react3.default.createElement("div", {
  ...
  }, " Send message ")))))))), /* @__PURE__ */ import_react3.default.createElement("section", {
  ...
  }, "Julie's painting exceeded my expectations; I'm thoroughly satisfied with the purchase. A stunning masterpiece that captivates with its beauty."), /* @__PURE__ */ import_react3.default.createElement("p", {
    className: "mt-5 text-sm font-bold text-gray-900"
  }, "Matthew"), /* @__PURE__ */ import_react3.default.createElement("p", {
    className: "mt-1 text-sm text-gray-600"
  }, "May 13, 2023"))))))), /* @__PURE__ */ import_react3.default.createElement("footer", {
...
function ShopRoute() {
  let { info } = (0, import_react6.useLoaderData)(), [products, setProducts] = (0, import_react5.useState)([]);
  return (0, import_react5.useEffect)(() => {
    ...
    className: "relative"
  }, "Contact")), /* @__PURE__ */ import_react5.default.createElement("a", {
    href: "#",
    className: "mr-[0.5rem] relative py-1.5 text-white before:absolute before:inset-0 before:origin-bottom before:scale-y-[.03] before:bg-white/60 before:transition before:duration-300 hover:before:scale-y-100 hover:before:scale-x-125 hover:before:bg-white/10 -mt-10"
  }, /* @__PURE__ */ import_react5.default.createElement("span", {
    className: "relative"
    ...
    className: "rellax text-6xl font-bold text-white sm:text-8xl md:text-9xl xl:leading-tight sm:mt-40 md:mt-66 lg:mt-54 xl:mt-0 2xl:mt-0",
    style: { fontFamily: "Covered by Your Grace", textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)" }
  }, "Art For Purchase")))), /* @__PURE__ */ import_react5.default.createElement("section", {
    id: "work",
    className: "relative bg-black pb-20 pt-32 md:pb-0 lg:pb-32 xl:pt-96 flex justify-center"
  }, /* @__PURE__ */ import_react5.default.createElement("div", {
    className: "grid grid-cols-1 md:grid-cols-2 gap-4 bg-white"
  }, products.map((product) => /* @__PURE__ */ import_react5.default.createElement("div", {
    key: product.id,
    className: "p-4 border border-gray-300 rounded shadow-md"
  }, /* @__PURE__ */ import_react5.default.createElement("h2", {
    className: "text-2xl font-bold mb-2 text-gray-800"
  }, product.name), /* @__PURE__ */ import_react5.default.createElement("p", {
    className: "mb-4 text-gray-600"
  }, product.custom_summary), /* @__PURE__ */ import_react5.default.createElement("img", {
  ...
  }, "Price: ", product.formatted_price), /* @__PURE__ */ import_react5.default.createElement("a", {
    href: product.short_url,
    className: "text-blue-500 hover:underline"
  }, "Purchase"))))))), /* @__PURE__ */ import_react5.default.createElement("footer", {
    className: "relative bg-black pt-32 backdrop-opacity-0"
  }, /* @__PURE__ */ import_react5.default.createElement("div", {
    className: "mx-auto max-w-7xl px-6 pb-12 lg:px-12 xl:px-6 2xl:px-0"
...
init_react();
var assets_manifest_default = { version: "c87970fb", entry: { module: "/build/entry.client-HR2D2GYH.js", imports: ["/build/_shared/chunk-VLWZG3OR.js", "/build/_shared/chunk-O6YYFGCX.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-PIL2PQQC.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/index": { id: "routes/index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/index-Y45TPT5E.js", imports: ["/build/_shared/chunk-DYWSBADA.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/index.client": { id: "routes/index.client", parentId: "root", path: "client", index: void 0, caseSensitive: void 0, module: "/build/routes/index.client-U24MRD5E.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/shop": { id: "routes/shop", parentId: "root", path: "shop", index: void 0, caseSensitive: void 0, module: "/build/routes/shop-4XIXIHYH.js", imports: ["/build/_shared/chunk-DYWSBADA.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, url: "/build/manifest-C87970FB.js" };
