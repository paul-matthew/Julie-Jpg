 ...
 */
export declare type TypedResponse<T> = Response & {
    json(): Promise<T>;
};
...
} : T extends ReadonlyArray<infer U> ? (U extends NonJsonPrimitives ? null : SerializeType<U>)[] : T extends object ? SerializeObject<UndefinedOptionals<T>> : never;
declare type SerializeObject<T> = {
    [k in keyof T as T[k] extends NonJsonPrimitives ? never : k]: SerializeType<T[k]>;
};
declare type UndefinedOptionals<T extends object> = Merge<{
...
export declare function useLoaderData<T = AppData>(): UseDataFunctionReturn<T>;
/**
 * Returns the JSON parsed data from the current route's `action`.
 *
 * @see https://remix.run/api/remix#useactiondata
 */
export declare function useActionData<T = AppData>(): UseDataFunctionReturn<T> | undefined;
/**
